...
<?php while ($row = mysqli_fetch_assoc($res)) { ?>
  <tr>
    ...
    <a href="updateloan.php?loan_name=<?php echo $row['loan_name']; ?>" class="btn btn-success">Update</a>
    <a href="checkdeleteloan.php?loan_name=<?php echo $row['loan_name']; ?>" class="btn btn-danger">Delete</a>
    </td>
  </tr>
<?php } ?>
